...
export function AuthWizard({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-surface-50 dark:bg-surface-50 transition-colors duration-300">
