    ...
    >
      {!isExpanded ? (
        ...
        <div
          ...
          className="flex items-center gap-2.5 sm:gap-3 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full border border-md-outline-variant/60 shadow-2xl backdrop-blur-xl bg-md-surface-container-lowest/95 dark:bg-md-surface-container-high/95 text-md-on-surface hover:border-md-primary transition-all group"
        >
        ...
        <div className="w-[calc(100vw-24px)] max-w-[360px] rounded-3xl border border-md-outline-variant/60 shadow-2xl backdrop-blur-2xl bg-md-surface-container-lowest/95 dark:bg-md-surface-container-high/95 text-md-on-surface p-4 space-y-3">
          {/* Header Drag Bar */}
          ...
          {activeUploads.map((u) => (
            <div
              key={u.fileId}
              className="p-3 rounded-2xl bg-md-surface-container-low/70 dark:bg-md-surface-container/70 border border-md-outline-variant/20 space-y-2"
            >
          ...
          {/* Active Download */}
          {downloadProgress && (
            <div className="p-3 rounded-2xl bg-md-surface-container-low/70 dark:bg-md-surface-container/70 border border-md-outline-variant/20 space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="font-bold text-md-on-surface truncate mr-2">
                  ⬇️ {downloadProgress.name}
                </span>
                <div className="flex items-center gap-2 shrink-0">
                  <span className="text-[11px] font-mono font-bold text-color-success">
