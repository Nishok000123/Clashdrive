  ...
  return (
    <div className="h-screen max-h-screen overflow-hidden bg-surface-50 dark:bg-surface-50 flex flex-col relative transition-colors duration-300">
      ...
      {selectedFileIds.size > 0 && (
        <div 
          className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-40 glass rounded-[20px] sm:rounded-[24px] px-3.5 sm:px-6 py-2.5 sm:py-3.5 flex items-center gap-2.5 sm:gap-4 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.3)] animate-scale-in border border-brand-500/25 max-w-[95vw] sm:max-w-none overflow-x-auto no-scrollbar"
          style={{ backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)" }}
        >
          <div className="text-[11px] font-black text-surface-900 shrink-0 uppercase tracking-wider select-none flex items-center whitespace-nowrap">
            <span className="text-brand-500 font-black text-sm mr-1.5">{selectedFileIds.size}</span>
            <span>Selected</span>
          </div>
          <div className="h-5 w-[1px] bg-surface-300/40 dark:bg-surface-300/10 shrink-0" />
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <button
              ...
              className="flex items-center justify-center gap-1.5 h-9 px-3.5 sm:px-4 rounded-xl bg-brand-500/10 hover:bg-brand-500/20 text-brand-500 text-xs font-bold border border-brand-500/20 active:scale-95 transition-all cursor-pointer select-none whitespace-nowrap shrink-0"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 h-9 px-3.5 sm:px-4.5 rounded-xl bg-brand-500 hover:bg-brand-600 text-white text-xs font-bold shadow-sm shadow-brand-500/20 active:scale-95 transition-all cursor-pointer select-none border border-brand-600/10 whitespace-nowrap shrink-0"
            >
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 h-9 px-3.5 sm:px-4 rounded-xl bg-danger/10 hover:bg-danger/20 text-danger text-xs font-bold transition-all border border-danger/20 active:scale-95 cursor-pointer select-none whitespace-nowrap shrink-0"
            >
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
            ...
            <button
              ...
              className="flex items-center justify-center h-9 px-3 sm:px-4 rounded-xl bg-surface-200 hover:bg-surface-300 dark:bg-surface-300/20 dark:hover:bg-surface-300/35 text-surface-700 text-xs font-bold active:scale-95 transition-all cursor-pointer select-none whitespace-nowrap shrink-0"
            >
              Cancel
            </button>
          </div>
